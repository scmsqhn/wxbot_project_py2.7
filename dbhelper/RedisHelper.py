...
class RedisHelper(ISqlHelper):
    ...
    arg2：0 数据库 编号
    '''
    def __init__(self, arg0=0, arg1='127.0.0.1', arg2=6379):
    ...
    def hset(self,arg0,arg1,arg2):
      self.r.hset(self,arg0,arg1,arg2)

    ''''' LIST 列表 左侧 添加操作
    arg0：LIST 名称
    arg1：VALUE 值
    '''
    def lpush(self,arg0,arg1):
      rt=self.r.lpush(self,arg0,arg1)
      print(rt)
